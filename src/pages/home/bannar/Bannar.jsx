        ...
        <div className="relative h-[450px] overflow-hidden rounded-lg md:h-96">
          ...
          >
            ...
            <div className="absolute  p-4 flex justify-center  flex-col text-white h-full w-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]  ">
              ...
              <div>
              <button type="button" class="text-white mt-4 bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Discover More</button>
              </div>
            </div>
          </div>
